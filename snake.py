...
class Game:
    ...
    def play(self, net) -> int:
        ...
        while True:
            ...
            #Reward for being alive and eating to keep this state
            points += 0.005
            ...
            #Check distance to obsticles (Up, Down, Left, Right)
            du = head[1] - u
            dd = d - head[1]
            dl = head[0] - l
            dr = r - head[0]
            ...
            #snake.direction = directions[int(output[0])][int(output[1])]
